...
def find_user(request,username):
    ...
    return render(request, 'awards/find_user.html', {'profile':profile, "projects":projects})
...
def review_project(request,id):
    ...
    return render(request, 'awards/review_project.html',{'project':project, 'current_user': current_user,  'form':form, 'comments':user_comment })
